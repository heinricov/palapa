...
import {
  MdxPagination,
  MdxPaginationPage,
} from "@workspace/mdx/mdx-pagination"

interface MdxReadingProps {
  className?: string
}

export const MdxReading = ({ className }: MdxReadingProps) => {
          ...
          >
            ...
            <div className="ml-3.5">
              <div className="relative flex items-start pb-2">
                <div className="absolute top-11 h-[calc(100%-2.75rem)] w-px bg-border/70"></div>
                ...
                <div className="pl-12">
                  ...
                  <p>
                    ...
                    Office. Each joke is carefully cataloged and assigned a tax
                    bracket based on its humor level.
                  </p>
                </div>
              </div>
              <div className="relative flex items-start pb-2">
                ...
                <div className="pl-12">
                  ...
                  <p>
                    The Royal Jesters evaluate each joke based on wit, delivery,
                    and audience reaction. Higher ratings mean higher taxes,
                    making the finest jokes a luxury few can afford.
                  </p>
                </div>
              </div>
              <div className="relative flex items-start pb-2">
